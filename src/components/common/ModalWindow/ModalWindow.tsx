...
import { ProfileDataFormValuesT, ProfileDataReduxForm } from '../../Profile/ProfileInfo/ProfileDataForm'
...
export const ModalWindowBlock: FC<ModalWindowBlock> = ({ profile, onSubmit }) => {
	return createPortal(
		<StyledModalWindow>
