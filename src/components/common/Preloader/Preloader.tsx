...
export const Preloader: FC<IPreloader> = ({
	preloader,
	maxWidthForPreloader,
	maxHeightForPreloader
}) => {
	return (
		<div>
			<StyledPreloader
				src={preloader}
				alt={preloader}
				maxWidthForPreloader={maxWidthForPreloader}
...
const StyledPreloader = styled.img<IStyledPreloader>`
	...
	${(props) =>
		props.maxWidthForPreloader &&
		css<IStyledPreloader>`
			max-width: ${props.maxWidthForPreloader};
		`}
	${(props) =>
		props.maxHeightForPreloader &&
		css<IStyledPreloader>`
